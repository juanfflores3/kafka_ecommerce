...
class ServerStub(object):
    ...
    def __init__(self, channel):
        ...
        self.ProcessOrder = channel.unary_unary(
                '/server.Server/ProcessOrder',
                request_serializer=server__pb2.OrderRequest.SerializeToString,
...
def add_ServerServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'ProcessOrder': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=server__pb2.OrderRequest.FromString,
...
class Server(object):
    ...
    def ProcessOrder(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/server.Server/ProcessOrder',
            server__pb2.OrderRequest.SerializeToString,
